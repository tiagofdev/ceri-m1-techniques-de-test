...
public class RocketFactory implements IPokemonFactory {
    ...
    public Pokemon createPokemon(int index, int cp, int hp, int dust, int candy) {
        ...
        if (index < 0) {
            ...
            attack = fr.univavignon.pokedex.imp.RocketFactory.generateRandomStat();
            defense = fr.univavignon.pokedex.imp.RocketFactory.generateRandomStat();
            stamina = fr.univavignon.pokedex.imp.RocketFactory.generateRandomStat();
            iv = 1;
        }
